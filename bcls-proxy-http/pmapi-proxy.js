 ...
 * Description: Proxies Brightcove Player Managment API requests, getting an access token, making the call, and returning
        ...
        req.on("end", function () {
            ...
            getFormValues(body, function (error) {
                if (error === null) {
                    ...
                    res.statusCode = 302;
                    res.setHeader("Location", "http://solutions.brightcove.com/bcls/bcls-proxy/pmapi-proxy.html");
                    res.end();
                }
            });
        });
