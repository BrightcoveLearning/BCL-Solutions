 ...
 * Description: Proxies Brightcove Dynamic Ingest API requests, getting an access token, making the call, and returning
...
var AAPIPROXY = (function () {
     ...
     */
    aapiServer = https.createServer(serverOptions, function (req, res) {
        var body = "",
        ...
        req.on("end", function () {
            ...
            getFormValues(body, function (error) {
                if (error === null) {
                    ...
                    res.statusCode = 302;
                    res.setHeader("Location", "http://solutions.brightcove.com/bcls/bcls-proxy/aapi-proxy.html");
                    res.end();
                }
            });
        });
