...
var DIAPIPROXY = (function () {
     ...
     * Dynamic Ingest API
     */
    diapiServer = https.createServer(serverOptions, function (req, res) {
        var body = "",
        ...
        req.on("end", function () {
            ...
            getFormValues(body, function (error) {
                if (error === null) {
                    ...
                    res.statusCode = 302;
                    res.setHeader("Location", "http://solutions.brightcove.com/bcls/bcls-proxy/diapi-proxy.html");
                    res.end();
                }
            });
        });
