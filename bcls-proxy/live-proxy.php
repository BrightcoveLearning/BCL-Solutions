...
if (strpos($_POST["url"], 'api.brightcove.com') == false && strpos($_POST["url"], 'api.bcovlive.io') == false && strpos($_POST["url"], 'data.brightcove.co.jp') == false && strpos($_POST["url"], 'data.brightcove.com') == false) {
